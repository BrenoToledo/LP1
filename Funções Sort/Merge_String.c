...
/*
Neste código, a função merge é usada para mesclar dois sub-arrays em ordem crescente. Ela recebe o array principal,
o sub-array esquerdo, o tamanho do sub-array esquerdo, o sub-array direito e o tamanho do sub-array direito.
A função percorre os sub-arrays comparando e mesclando os elementos em ordem crescente.

A função mergeSort é uma implementação recursiva do algoritmo Merge Sort. Ela divide o array em dois sub-arrays
*/

// Função para mesclar duas sub-arrays em ordem crescente
